...
<div class="row">
  ...
  <div class="col-lg-2 mb-4">
    ...
    <div class="list-group">
      <a class="list-group-item list-group-item-action disabled">관리자</a>
      <a href="admin_index.php" class="list-group-item list-group-item-action ">회원 정보 관리</a>
      <a href="admin_a.php" class="list-group-item list-group-item-action">공지사항 관리</a>
      <a href="admin_b.php" class="list-group-item list-group-item-action active bg-dark ">베너 관리</a>
      <a href="admin_c.php" class="list-group-item list-group-item-action ">1대1 질문 관리</a>
      <a href="admin_d.php" class="list-group-item list-group-item-action ">추천 상품 관리</a>
    </div>
  </div>
  <!-- Content Column -->
  ...
  <div class="col-lg-8 mb-4">
    ...
    <form enctype="multipart/form-data" method="post"action="admin_b.php">
