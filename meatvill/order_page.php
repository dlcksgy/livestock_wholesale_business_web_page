    ...
    <p class="button"><a href="javascript:window.history.back();" class="btnSimple">이전페이지</a></p>
      ...
      <table id="order_production">
        ...
        <tfoot><tr>
          <td></td>
          <td colspan="8">
            <span class="gLeft">[기본배송]</span> 상품구매금액 <strong><?php echo $arr[1];?> won<span class="displaynone"></span></strong><span class="displaynone"> </span> + 배송비 무료 <span id="domestic_ship_fee"></span> <span class="displaynone"> - 상품할인금액 0 won </span> = 합계 : <strong class="gIndent10"><span id="domestic_ship_fee_sum" class="txt12"><?php echo $arr[1];?></span> won</strong> <span class="displaynone"></span>
          </td>
        </tr></tfoot>
        <tbody class="xans-element- xans-order xans-order-normallist center">
          <tr class="order_num_">
            ...
            <td><img src=<?php echo '"./img/'.$title.'/'.$subtitle.'/'.$selected.'.jpg"'; ?> width="300"/></td>
            <td>
              <a href="information.php"><strong><?php echo $selected; ?></strong></a>
              <p class="gBlank5 displaynone">유효기간 : ~2018-01-02</p>
            </td>
            <td>
              <div>
                <strong><?php echo $arr[1];?> won</strong><p class="displaynone"></p>
              </div>
            </td>
            <td>1</td>
            ...
            <td><strong><?php echo $arr[1];?> won</strong></td>
          </tr>
        </tbody>
