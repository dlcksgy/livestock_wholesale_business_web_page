...
<div class="row">
  ...
  <div class="col-lg-2 mb-4">
    ...
    <div class="list-group">
      ...
      <a href="admin_index.php" class="list-group-item list-group-item-action active bg-dark">회원 정보 관리</a>
      <a href="admin_a.php" class="list-group-item list-group-item-action">공지사항 관리</a>
      <a href="admin_b.php" class="list-group-item list-group-item-action ">베너 관리</a>
