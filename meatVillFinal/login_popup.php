...
<div class="row">
  ...
  <div class="col-lg-5 mb-4">
    ...
    <form class="text-center border border-light p-5" method="post">
      ...
      <?php endif ?>
      <!-- Email -->
      <input type="text" id="defaultLoginFormId" class="form-control mb-4" placeholder="아이디" name="login" required>

      <!-- Password -->
      <input type="password" id="defaultLoginFormPassword" class="form-control mb-4" placeholder="비밀번호" name="password" required>
